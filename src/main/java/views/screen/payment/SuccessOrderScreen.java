...
public class SuccessOrderScreen extends BaseScreenHandler {
    ...
    @FXML private Text transactionDate;
    @FXML private Text transactionContent;


    public SuccessOrderScreen(Stage stage, String screenPath, Invoice invoice, PaymentTransaction paymentTransaction) throws IOException {
        ...
        transactionDate.setText(paymentTransaction.getCreatedAt());
